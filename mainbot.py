...
while True:
    user = api.get_user('HARISH_372k')
    api.update_profile(name=f'harish|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : harish|{follower_count(user)} Followers')
